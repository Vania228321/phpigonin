            ...
            <div class="header-inner">
                ...
                <div class="header-right">
                    <div class="header-icons">
                        <a class="header-icon" href="#">Здравствуй, <?= $_SESSION['email'] ?></a>

                        <a class="header-icon" href="?do=exit">
                            <img class="sign-up" src="img/icons/icons-header/arrow-right-to-bracket-solid.svg" alt="Sign-Up" height="36px" width="30px">
                            <p class="sign-up-text">Выйти</p>
                        </a>

                        <a class="header-icon" href="?do=delete">
                            <img class="sign-up" src="img/icons/icon-user.png" alt="Sign-Up" height="36px" width="30px">
                            <p class="sign-up-text">Удалить аккаунт</p>
                        </a>
                        ...
                        if (isset($_GET['do']) and $_GET['do'] === "delete") {
                            $deleting_email = $_SESSION['email'];
                            $pdo->prepare("DELETE FROM users WHERE email = ?")->execute([$deleting_email]);
                            unset($_SESSION['email']);
                            unset($_SESSION['auth']);
                            header("Location: ../../index.php");
                            die();
            ...
            <div class="intro-inner">
                <div class="intro-categories">
                    ...
                    <div class="intro-choice-categories">
                        <a class="intro-choice-categorie" href="catalog/index.html">Футболки<i class="fa fa-caret-right" style="color: #7F7F7F;"></i></a>
            ...
            <div class="partners-inner">
                <div class="slider">
                    <div class="slider__line">
                        <img class="slider__img" height="500px" src="./img/slider/adidas.jpg">
                        <img class="slider__img" height="500px" src="./img/slider/nike.jpg">
                        <img class="slider__img" height="500px" src="./img/slider/reebok.jpg">
                        <img class="slider__img" height="500px" src="./img/slider/adidas.jpg">
                    </div>
            ...
            <div class="footer-inner">
                <div class="footer-blocks">
                    <div class="footer-block">
                        ...
                        <a href="catalog/index.html" class="footer-btn">Контакты</a>
                    ...
                    <div class="footer-block">
                        ...
                        <a href="index.html"><img src="img/footer/1.png" height="35" alt=""></a>
                        <a href="index.html"><img src="img/footer/2.png" height="35" alt=""></a>
                    </div>
                </div>
