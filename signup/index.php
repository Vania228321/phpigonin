            ...
            <div class="form-inner">
                <?php
                    if (isset($_SESSION['flash'])) {
                        echo "<p class='flash_message' style='color: #000; margin: 20px 0 0 0; font-size: 24px;'>{$_SESSION['flash']}</p>";
                ...
                <div class="exit">
                    ...
                    <a href="index.php" style="display: inline; color: #000;">Регистрация</a>
                </div>

                <form action="register.php" method="post" class="form-body">
                    <div class="form-fields">
                        <div class="form-title">Регистрация</div>
                        <div class="form-name">Электронная почта</div>
                        <input name="email" type="email" placeholder="Введите почту">
                        <div class="form-name" style="padding-top: 10px;">Логин</div>
                        <input name="login" type="text" style="margin-bottom: 18px;" placeholder="Введите логин">
                        ...
                        <div class="form-name" style="padding-top: 10px;">Повторите пароль</div>
                        <input name="repeated_password" type="password" style="margin-bottom: 18px;" placeholder="Повторите пароль">
                    </div>
                    <input type="checkbox" class="form-checkbox"><label class="write">Согласие на обработку данных</label>
                    <div></div>
                    <input name="send" type="submit" class="form-submit" value="Зарегистрироваться">
                </form>
